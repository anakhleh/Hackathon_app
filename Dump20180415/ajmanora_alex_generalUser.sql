...
CREATE TABLE `generalUser` (
  ...
  PRIMARY KEY (`email`),
  CONSTRAINT `generalUser_ibfk_1` FOREIGN KEY (`email`) REFERENCES `db_user` (`email`)
...
INSERT INTO `generalUser` VALUES ('testgeneraluser');
...
-- Dump completed on 2018-04-15 18:12:36
